...
export default function App() {
  ...
  useEffect(() => {
    const fetchPrices = async () => {
      try {
        const response = await fetch('http://localhost:5000/api/silver-prices');
        if (!response.ok) {
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 md:justify-end md:gap-8">
            {menuItems.map((item) => (
              <button
                ...
                className="group relative text-sm font-bold uppercase tracking-wide text-black transition-opacity duration-200 hover:opacity-80 sm:text-base md:text-lg"
              >
              ...
              <div className="rounded-[28px] bg-gradient-to-b from-sky-50/80 via-blue-50/45 to-cyan-50/30 px-4 py-8 sm:rounded-[32px] sm:px-6 sm:py-12">
                <div className="mx-auto max-w-4xl text-center">
                  ...
                  <p className="mt-8 text-sm leading-7 text-black/75 sm:text-base md:text-lg md:leading-8">
                    ...
                    genuine products, and dependable service you can rely on.
                    We take pride in building long-term relationships with our
                    customers through honesty, consistency, and excellence.
                  </p>
            ...
            <section className="w-full rounded-[28px] border border-blue-100/80 bg-white/35 p-4 backdrop-blur-xl shadow-[0_20px_80px_rgba(186,230,253,0.55),0_10px_40px_rgba(59,130,246,0.08)] sm:rounded-[32px] sm:p-6 md:p-10">
              ...
              <div className="mx-auto mt-8 max-w-4xl space-y-6 text-center md:text-justify">
                <p className="text-sm leading-7 text-black/80 sm:text-base md:text-lg md:leading-8 md:text-justify">
                  Established in 2080 B.S., DPPL began its journey by supplying
                  silver granules exclusively for business purposes. Like every
                  growing business, we faced ups and downs along the way, but
                  those experiences made us stronger and helped us understand
                  the market more deeply.
                </p>

                <p className="text-sm leading-7 text-black/80 sm:text-base md:text-lg md:leading-8 md:text-justify">
                  With time and careful market analysis, we recognized a growing
                  need to make silver investment more accessible. As a result,
                  in 2082 B.S., we started manufacturing silver bars for
                  investment purposes.
                </p>

                <p className="text-sm leading-7 text-black/80 sm:text-base md:text-lg md:leading-8 md:text-justify">
                  Today, DPPL is proud to provide silver bars for investors and
                  silver granules for business use only. Our journey is built on
                  trust, learning, and commitment, and we continue to serve our
                  customers with honesty, care, and quality.
                </p>
              </div>
                ...
                <div className="mt-8 grid gap-6 md:grid-cols-3">
                  <div className="rounded-[24px] border border-white/70 bg-white/55 p-5 text-center shadow-[0_12px_40px_rgba(125,211,252,0.16)] backdrop-blur-xl sm:rounded-[28px] sm:p-6">
                    ...
                    <p className="mt-5 text-sm leading-7 text-black/80 sm:text-base">
                      DPPL WAS ESTABLISHED. WE STARTED BY SELLING SILVER
                      GRANULES FOR BUSINESS PURPOSES ONLY.
                    </p>
                  </div>
                  ...
                  <div className="rounded-[24px] border border-white/70 bg-white/55 p-5 text-center shadow-[0_12px_40px_rgba(125,211,252,0.16)] backdrop-blur-xl sm:rounded-[28px] sm:p-6">
                    ...
                    <p className="mt-5 text-sm leading-7 text-black/80 sm:text-base">
                      AFTER ANALYZING THE MARKET, WE BEGAN PRODUCING SILVER BARS
                      TO HELP PEOPLE INVEST IN SILVER.
                    </p>
                  </div>
                  ...
                  <div className="rounded-[24px] border border-white/70 bg-white/55 p-5 text-center shadow-[0_12px_40px_rgba(125,211,252,0.16)] backdrop-blur-xl sm:rounded-[28px] sm:p-6">
                    ...
                    <p className="mt-5 text-sm leading-7 text-black/80 sm:text-base">
                      WE OFFER SILVER BARS FOR INVESTMENT AND SILVER GRANULES
                      FOR BUSINESS PURPOSES ONLY, WITH TRUST, QUALITY, AND
